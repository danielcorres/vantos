-- move_lead_stage: al avanzar a etapas clave, rellenar timestamps si aún son null.
-- casos_abiertos -> cita_realizada_at; citas_cierre -> propuesta_presentada_at; casos_ganados -> cerrado_at.
-- No sobrescribir si ya tienen valor. Usar coalesce(p_occurred_at, now()).
...
begin
  ...
  -- validar etapa destino y obtener slug
